...
//small test
int main(){
    STDtest std("/home/ofek/CLionProjects/The_Best_Project/input.txt","/home/ofek/CLionProjects/The_Best_Project/output.txt");
    CLI cli(&std);
    cli.start();
    std.close();
    check("output.txt","/home/ofek/CLionProjects/The_Best_Project/expectedOutput.txt");
    cout<<"done"<<endl;
    return 0;
}